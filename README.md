...
- [x] тестируем 2 и более приложений ваших коллег
- [x] если находите функциональные недостатки, заводите баг репорт через issue на github
- [x] факсим баги и устраняем проблемы, которые озвучили ваши коллеги
- [x] разрабатываем новую фичу (SSR) по git flow.
- [x] настраиваем простую конфигурацию SSR на приложении.
